...
forest_fires = pd.read_csv('personal_python/forestfires.csv')
CO2_emissions = pd.read_csv('personal_python/CO2Emission_LifeExp.csv')
cleaned_df = pd.read_csv("./Dhwani/Year_Country_AvgTemp.csv")
Emission = CO2_emissions
city = pd.read_csv("./GlobalWarming_InterestBy_City.csv")
# breakdown = pd.read_csv("./Breakdown_City.csv")
